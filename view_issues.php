...
<html lang="en">
  <head>
    ...
    <title>View Issues/ Accidents Page</title>
              ...
              <div class="topnav" id="myTopnav">
                ...
                <div class="secnav">
                      ...
                      <?php
                          ...
                          //SQL Query to select all data from a table called issues
                  ...
                  <div class="table">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td><a href="edit_issues.php?id=<?php echo $row['id'] ?> " style="background-color: #0984e3;color: white; padding: 5px 15px; text-align: center; text-decoration: none; border-radius: 5px;"; >Edit</td>
                                <td><a onclick="return confirm('Are you sure you want to delete?')" href="delete_issues.php?id=<?php echo $row['id'] ?>" style="background-color: crimson;color: white; padding: 5px 15px; text-align: center; text-decoration: none; border-radius: 5px;"; >Delete</td>
                            </tr>
                                <?php
                                      }
                                  }
