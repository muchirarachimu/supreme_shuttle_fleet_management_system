    ...
    <center> 
        <div class="form">
                <form action="login-user.php" method="POST" autocomplete="">
                    <h2 style= "color:#192a56;">Please Login Admin</h2>
                    <?php
                    if(count($errors) > 0){
                        ?>
            ...
            <p> Don't have an Account? <a href="signup-user.php" style="background-color:crimson; text-decoration:none;">Signup Now</a></p>
                </form>
        </div>
        </center>
</body>
