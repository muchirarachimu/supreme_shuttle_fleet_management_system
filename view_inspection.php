...
<html lang="en">
  <head>
    ...
    <title>View Inspection Page</title>
                ...
                <div class="secnav">
                  ...
                  <a href="view_inspection.php">Inspection</a>
                    ...
                    <?php
                      ...
                      //SQL Query to select all data from a table called inspection
                  ...
                  <div class="table">
                      ...
                      <p><a href="insert_inspection.php">Insert Inspection Details </a></p> 
                      <table>
                          <tr>
                          ...
                          <tr>
                              ...
                              <td><?php echo $row['last_inspection'] ?></td>
                              <td><?php echo $row['next_inspection'] ?></td>
                              <td style="color:red; font-weight:600;"><?php echo $row['status'] ?></td> 
                              <td><?php echo $row['remaining_days'] ?></td>   
                              <td><a href="edit_inspection.php?id=<?php echo $row['id'] ?> " style="background-color: #0984e3;color: white; padding: 5px 15px; text-align: center; text-decoration: none; border-radius: 5px;"; >Edit</td>
                              <td><a onclick="return confirm('Are you sure you want to delete?')" href="delete_inspection.php?id=<?php echo $row['id'] ?>" style="background-color: crimson;color: white; padding: 5px 15px; text-align: center; text-decoration: none; border-radius: 5px;"; >Delete</td>
                          </tr>
                          <?php
                                    }
                                }
