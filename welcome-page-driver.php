...
<head>
    <meta charset="UTF-8">
    <title><?php echo $fetch_info['name'] ?>Welcome Page Driver</title>
...
<!--<button style="float:right; padding: 5px;"> <a href="driver_accounts_registration.php">Create driver Accounts</a> </button>--> 
    ...
    <center>  
    <h2>Welcome <span>Driver &nbsp <?php echo $fetch_info['name'] ?></span></h2> 
    <!--<a href="view_driver.php" class="btn_proceed">Click here to Proceed</a>-->
<button class="btn_admin"> <a href="home_driver.php">Click here to Proceed</a> </button> 
