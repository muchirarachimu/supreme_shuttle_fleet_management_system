...
<html lang="en">
  <head>
    ...
    <title>View Insurance Page</title>
        ...
        <body>
              ...
              <div class="secnav">
                  ...
                  <a href="view_inspection.php">Inspection</a>
                    ...
                    <?php
                        include 'config.php';
                        $select="SELECT*FROM insurance"; // connect to database
                        //SQL Query to select all data from a table called insurance
                        $select_q=mysqli_query($con,$select);
                        $data=mysqli_num_rows($select_q);
                    ?>
                <!--Table to display data fetched from the database ---->
                <div class="table">
                        <h2>View Insurance Details</h2>
                        <p><a href="insert_insurance.php">Insert Insurance Details </a></p> 
                    <table>
                          <tr>
                              <th>Vehicle Registration Number</th>
                              <th>Nickname</th>
                              <th>Date of Last Insurance</th>
                              <th>Date of Next Insurance</th>
                              <th >Status</th>
                          ...
                          <tr>
                              ...
                              <td><?php echo $row['previous_insurance_date'] ?></td>
                              <td><?php echo $row['next_insurance_date'] ?></td>
                              <td style="color:red; font-weight:600;"><?php echo $row['status'] ?></td> 
                              <td><?php echo $row['remaining_days'] ?></td>                       
                              <td><a href="edit_insurance.php?id=<?php echo $row['id'] ?> " style="background-color: #0984e3;color: white; padding: 5px 15px; text-align: center; text-decoration: none; border-radius: 5px;"; >Edit</td>
                              <td><a onclick="return confirm('Are you sure you want to delete?')" href="delete_insurance.php?id=<?php echo $row['id'] ?>" style="background-color: crimson;color: white; padding: 5px 15px; text-align: center; text-decoration: none; border-radius: 5px;"; >Delete</td>
                          </tr>
                          <?php
                                  }
                                }
