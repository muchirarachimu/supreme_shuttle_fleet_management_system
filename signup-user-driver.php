...
<head>
    <meta charset="UTF-8">
    <title>Signup Page Driver</title>
...
<center>
            <div class="form">
                <form action="signup-user-driver.php" method="POST" autocomplete="">
            ...
            <p> Already have an account? <a href="login-user-driver.php">Login Now</a></p>
                </form>
            </div>
                </center>
