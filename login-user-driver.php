...
<a href="#.php"><img src="/images/supremeshuttlelogo.png"></a>
    ...
    <center> 
        <div class="form">
                <form action="login-user-driver.php" method="POST" autocomplete="">
                    <h2 style= "color:#192a56;">Please Login Driver</h2>
                    <?php
                    if(count($errors) > 0){
                        ?>
            ...
            <a href="forgot-password-driver.php">Forgot password?</a>

            <p> Don't have an Account? <a href="signup-user-driver.php" style="background-color:crimson; text-decoration:none;">Signup Now</a></p>
                </form>
        </div>
        </center>
</body>
