...
<html lang="en">
  <head>
    ...
    <title>View Appraisal Page</title>
    ...
    <link href="https://cdn.jsdelivr.net/npm/bootstrap@5.2.3/dist/css/bootstrap.min.css" rel="stylesheet" integrity="sha384-rbsA2VBKQhggwzxH7pPCaAqO46MgnOM80zW1RWuH61DGLwZJEdK2Kadq2F9CUG65" crossorigin="anonymous">
          ...
          <body>
              ...
              <div class="secnav">
                    ...
                    //SQL Query to select all data from a table called appraisal
              ...
              <div class="table">
                    ...
                    <table>
                        ...
                        <tr>
                            ...
                            <td><a href="edit_appraisal.php?id=<?php echo $row['id'] ?> " style="background-color: #0984e3;color: white; padding: 8px 18px; text-align: center; text-decoration: none; border-radius: 5px;"; >Edit</td>
                            <td><a onclick="return confirm('Are you sure you want to delete?')" href="delete_appraisal.php?id=<?php echo $row['id'] ?>" style="background-color: crimson;color: white; padding: 8px 18px; text-align: center; text-decoration: none; border-radius: 5px;"; >Delete</td>
                            </tr>
                            <?php
                                    }
                                }
