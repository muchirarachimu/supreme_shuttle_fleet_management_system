...
<html lang="en">
  <head>
    ...
    <title>View Vehicles Page</title>
    ...
    <body>
          ...
          <div class="secnav">
                ...
                <?php
                    ...
                    //SQL Query to select all data from a table called vehicles
          ...
          <div class="table">
                ...
                <p style="float:right"><a href="search_vehicle_form.php">Search Vehicle </a></p> 
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td><a href="edit_vehicle.php?id=<?php echo $row['id'] ?> " style="background-color: #0984e3;color: white; padding: 8px 18px; text-align: center; text-decoration: none; border-radius: 5px;"; >Edit</td>
                        <td><a onclick="return confirm('Are you sure you want to delete?')" href="delete_vehicle.php?id=<?php echo $row['id'] ?>" style="background-color: crimson;color: white; padding: 8px 18px; text-align: center; text-decoration: none; border-radius: 5px;"; >Delete</td>
                    </tr>
                        <?php
                            }
                            }
