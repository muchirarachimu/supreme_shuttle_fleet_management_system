...
<html lang="en">
  <head>
    ...
    <title>View Hired Vehicles Page </title>
    ...
    <body>
          ...
          <div class="secnav">
                ...
                //SQL Query to select all data from a table called hirings
                $select="SELECT*FROM hirings";
                $select_q=mysqli_query($con,$select);
                $data=mysqli_num_rows($select_q);
                ?>
          <!--Table to display data fetched from the database ---->
          <div class="table">
              <h2>View Hired Vehicles </h2>
                  <table>
                            <tr>
                                ...
                                <th>Phone</th>
                                <th>Address</th>
                                <th>Vehicle Category Description</th>
                                <th>Start Date</th>
                                <th>Start Date</th>
                                <th>Message</th>
                            ...
                            <tr>
                                ...
                                <td><a onclick="return confirm('Are you sure you want to delete?')" href="delete_hirings.php?id=<?php echo $row['id'] ?>" style="background-color:crimson;color: white; padding: 5px 15px; text-align: center; text-decoration: none; border-radius: 5px;"; >Delete</td>
                            </tr>
                            <?php
                                    }
                                }
